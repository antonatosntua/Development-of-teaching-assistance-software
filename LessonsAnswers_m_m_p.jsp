...
<%
    ...
    String id=" " +" and a.Id_Les_Ans="+Id_Les_Ans+" ";
    session.setAttribute("GLOBAL_CODE",id);
    session.setAttribute("whereParam", id);
...
StatementRecordset1 = ConnRecordset1.prepareStatement("select '' dsp_obj, a.Id_Les_Ans,a.Lesson_Id,a.Lesson_IdD,a.User_Id,a.User_IdD,a.Answer_Id,a.Answer_IdD,a.Answer_Date,a.Answer_DateD from EDTOOL.VW_LESSONS_ANSWERS a where 1=1 " +" and a.Id_Les_Ans="+Id_Les_Ans+" ");
...
<div  class="btn1">
       ...
       <a title="Κριτήρια Αναζήτησης"><input type="image"  id="find" src="images/find.png"  onClick="f835.action='LessonsAnswers_m_k.jsp';f835.submit();" ></a>
...
else {out.println("<div   align='center'><font color='#CC3333' size='8' >Δεν υπάρχουν εγγραφές</font></div><br><br><br><br>");}
%>
<%
 }
