...
String que ="SELECT A.Rn, A.User_Id, A.User_Idd, A.Courses_Idd, A.Lesson_Id, A.Lesson_Idd, TO_CHAR(A.Fr_Lesson_Date,'HH24.MI') L_F, A.Fr_Lesson_Dated, A.To_Lesson_Dated ,TO_CHAR(A.To_Lesson_Date,'HH24.MI') L_T , A.Fr_Lesson_Dated, A.To_Lesson_Dated, '( ' || A.Lesson_Id || ' ) ' || A.Lesson_Descr Lesson_Descr, A.Tot_Users, A.Hd_Stat_T, A.Hd_Stat_Data_T, A.Colspan_Cn_T, A.Plot_X_T, A.Plot_Y_T, A.Hd_Stat_Aa, A.Hd_Stat_Data_Aa, A.Colspan_Cn_Aa, A.Plot_X_Aa, A.Plot_Y_Aa, A.Hd_Stat_La, A.Hd_Stat_Data_La, A.Colspan_Cn_La, A.Plot_X_La, A.Plot_Y_La, A.Hd_Stat_Ax, A.Hd_Stat_Data_Ax, A.Colspan_Cn_Ax, A.Plot_X_Ax, A.Plot_Y_Ax, A.Start_Status S, A.End_Status E , f_find_start_end_answers ( A.Lesson_Id) ANS FROM ALL_LESSONS_STATISTIC A WHERE 1 = 1  AND SYSDATE BETWEEN Fr_Lesson_Date AND To_Lesson_Date  and user_id ="+session.getAttribute("UserId")+" "+query;
 //out.write(que);
