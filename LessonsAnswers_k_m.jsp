...
String id=" " +" and a.Lesson_Id="+Lesson_Id +" "+  " and a.User_Id= " + session.getAttribute("UserId");
...
String que ="select a.Id_Les_Ans,a.Lesson_Id,a.Lesson_IdD,a.User_Id,a.User_IdD,a.Answer_Id,a.Answer_IdD,Answer_DateD from VW_LESSONS_ANSWERS a where 1=1 "+ " and a.User_Id= " + session.getAttribute("UserId")+ id ;
 out.write(que);
...
<tr>
    <th  colspan="7" ><div id="m_h"  >Απαντήσεις Μαθημάτων<table>
<tr>
<td>
<div  class="btn1">
	   <a title="Επιστροφή"><input type="image" id="back" src="images/back.png"  onClick="history.go(-1);" ></a>
        <a title="Διόρθωση Εγγραφής"><input type="image" id="update"  src="images/update.png"  onClick="f835.action='LessonsAnswers_u.jsp';f835.submit();" ></a>
        <a title="Διαγραφή Εγγραφής"><input type="image"  id="remove" src="images/remove.png"  onClick="f835.action='LessonsAnswers_d.jsp';f835.submit();" ></a>
		</div>
</td>
</tr>
</table>
...
else {out.println("<div   align=\"center\"><font color=\"#CC3333\" size=\"8\" ><br>Δεν υπάρχουν εγγραφές</font><p><div><br><a href=\"LessonsAnswers_i.jsp\">"+
                  "<img src=\"images/add.png\" name=\"\" width=\"30\" height=\"30\" alt=\" Νέα Εγγραφή \"></a><a href=\"LessonsAnswers_k.jsp\">&nbsp;&nbsp;"+
