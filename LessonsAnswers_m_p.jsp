...
<div id="fixedbottom">
<% response.sendRedirect("LessonsAnswers_m_i.jsp");

}
else {
response.sendRedirect("LessonsAnswers_m_i.jsp");
//out.println("<div   align=\"center\"><font color=\"#CC3333\" size=\"8\" ><br>Δεν υπάρχfgfgfgfgουν εγγραφές</font><p><div><br><a href=\"LessonsAnswers_k_i.jsp\">"+
